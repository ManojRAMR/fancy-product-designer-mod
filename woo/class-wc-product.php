...
?>
		...
		public function after_product_designer($post)
		{
			...
			<script type="text/javascript">
				...
				jQuery(document).ready(function() {
					...
					// MRR trying to add fpd_data to add to quote button click
					$add_to_quote_mrr = $(".add-request-quote-button")

					console.log("This is out.")
					$add_to_quote_mrr.on("click", function(evt) {
					...
					$cartForm.on('click', ':submit', function(evt) {
						...
						if (order.product != false) {
							...
							fancyProductDesigner.viewInstances[0].toDataURL(function(dataURL) {
								...
								/* MRR - FPD add fpd_product data in json form */
								$cartForm.find('input[name="fpd_product"]').val(JSON.stringify(order));
								/* MRR-END */
								$cartForm.find('input[name="fpd_product_thumbnail"]').val(dataURL);
		...
		public function add_product_designer_form()
		{
			...
			?>
				...
				<!-- MRR - This is where "fpd_product" form name is data sets when add-to-cart clicked -->
